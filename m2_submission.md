...
<tr><td> <em>Generated: </em> 2/5/2022 11:53:35 AM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-010-S22/m2-php-hw/grade/vr355" target="_blank">Grading</a></td></tr></table>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/70603389/152631727-ce6ea962-3d90-4fea-b54b-4a3ed4be2575.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>The code is on left side where I loop through array using foreach<br>loop and check if each element of array is odd or even. I<br>print the element if it is odd and skip if it is even.<br>The right side of screenshot shows the correct output on heroku plateform.<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>I loop through array using foreach loop and check if each element of<br>array is odd or even. I print the element if it is odd<br>and skip if it is even.<br></p><br></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/70603389/152631757-b5b6cfad-36de-4bcb-ba6a-d388520dc961.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Left of side of screenshot shows the code including the logic of adding<br>number to total and right side shows the output<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>I loop through each element of array and add each element to total.<br>After that I round the total to 2 decimals by using builtin round<br>function.<br></p><br></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/70603389/152631793-923cfd98-4df6-400e-ba73-c7aed83b88e7.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Left side shows the logic and right side of screenshot shows the output<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>Loop through each element and print absolute value(without sign) of element using builtin<br>abs function of php<br></p><br></td></tr>
</table></td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://it202-vr-hw2.herokuapp.com/M2/Problem1.php">https://it202-vr-hw2.herokuapp.com/M2/Problem1.php</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://it202-vr-hw2.herokuapp.com/M2/Problem2.php">https://it202-vr-hw2.herokuapp.com/M2/Problem2.php</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://it202-vr-hw2.herokuapp.com/M2/Problem3.php">https://it202-vr-hw2.herokuapp.com/M2/Problem3.php</a> </td></tr>
<tr><td> <em>Sub-Task 4: </em> Pull Request URL for M2-PHP-HW to dev</td></tr>
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/vr355/IT202-010/pull/4">https://github.com/vr355/IT202-010/pull/4</a> </td></tr>
<tr><td> <em>Sub-Task 5: </em> Talk about what you learned, any issues you had, how you resolve them</td></tr>
<tr><td> <em>Response:</em> <p>Faced an issue while deploying to heroku. I forgot to include composer.json, composer.lock<br>and Procfile in the root directory. I added these files and issue was<br>resolved<br></p><br></td></tr>
</table></td></tr>
<table><tr><td><em>Grading Link: </em><a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-010-S22/m2-php-hw/grade/vr355" target="_blank">Grading</a></td></tr></table>